<script setup>
import AssignTeachersDialog from '@/components/students/AssignTeachersDialog.vue'
...
// Action Handlers
const handleAssignTeachers = (student) => {
  ...
  <div>
    ...
    <div class="mb-6">
      <div class="d-flex align-center justify-space-between mb-2">
        <div>
          <h2 class="text-h4 mb-1">Students</h2>
      ...
      <VDataTable :headers="headers" :items="items" :loading="loading" :items-per-page="itemsPerPage"
        ...
        <template #item.full_name="{ item }">
          <div class="d-flex align-center">
            <VAvatar :size="32" class="me-3" color="success" variant="tonal">
        ...
        <template #item.actions="{ item }">
          <VBtn
            ...
            @click="handleAssignTeachers(item)">
            Assign Teachers
          </VBtn>
        </template>
